              ...
              <div className="min-w-0">
                ...
                <div className="mt-1.5 flex flex-wrap items-center gap-4 text-xs text-zinc-500">
                  ...
                  <span className="inline-flex items-center gap-1.5">
                    ...
                    {formatDateTime(startTime, t('visitor.audienceRoom.notSet'))} – {formatDateTime(endTime, t('visitor.audienceRoom.notSet'))}
                  </span>
                </div>
              </div>
              <button
              ...
              <div className="mt-8">
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                  <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/5 border border-white/5">
                    ...
                    <span className="text-xs font-semibold text-white">{t('visitor.chatPanel.senderLabel')}</span>
                  </div>
