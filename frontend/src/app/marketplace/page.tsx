...
export default function MarketplacePage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white flex flex-col items-center justify-center p-6 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Marketplace</h1>
            <p className="text-gray-500 text-base max-w-md mb-8">
                Browse products and services offered by enterprise stands across all events.
                Visit a live event to explore stand marketplaces.
            </p>
            <Link
                href="/events"
