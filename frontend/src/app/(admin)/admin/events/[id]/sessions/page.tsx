...
const STATUS_CFG: Record<SessionStatus, { labelKey: string; cls: string; dot: string }> = {
    scheduled: { labelKey: 'admin.sessions.status.scheduled', cls: 'bg-zinc-100 text-zinc-600', dot: 'bg-zinc-400' },
    live: { labelKey: 'admin.sessions.status.live', cls: 'bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200', dot: 'bg-emerald-500 animate-pulse' },
    ended: { labelKey: 'admin.sessions.status.ended', cls: 'bg-blue-50 text-blue-700', dot: 'bg-blue-400' },
};
